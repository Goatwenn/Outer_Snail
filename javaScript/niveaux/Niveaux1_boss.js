class Niveaux1_boss extends Phaser.Scene {  // Copier Coller a modifier

    constructor (){
        super("Niveaux1_boss");   // Copier Coller a modifier
    }
    ...
    //--- Load du TileSet : ----------------------------------------------------------
        ...
        this.load.tilemapTiledJSON("Niveaux1_boss", 'assets/mondes/Niveaux1_boss.json');
    }
   ...
   //--- Input  :  ----------------------------------------------------------
    ...
    Sortie (player, spaceShip){
        if (this.Fruit[6] < this.nfruit){
            this.Fruit[6] = this.nfruit
        }
