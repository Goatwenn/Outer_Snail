class Niveaux1_4 extends Phaser.Scene {  // Copier Coller a modifier

    constructor (){
        super("Niveaux1_4");   // Copier Coller a modifier
    }
    ...
    //--- Load du TileSet : ----------------------------------------------------------
        ...
        this.load.tilemapTiledJSON("Niveaux1_4", 'assets/mondes/Niveaux1_4.json');
    }
    ...
    //--- Map Tiled : ----------------------------------------------------------
        ...
        this.map = this.add.tilemap('Niveaux1_4');
    ...
    CollectFruits (player, fruit){
     ...
     Sortie (player, spaceShip){
        if (this.Fruit[4] < this.nfruit){
            this.Fruit[4] = this.nfruit
        }
